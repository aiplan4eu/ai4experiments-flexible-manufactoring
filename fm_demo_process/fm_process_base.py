...
step_heat_treatment = Object("heat_treatment", type_step)
...
# # heat treatment & shot blasting (using 59)
# machine_H1 = Object("H1", type_machine)
# machine_H2 = Object("H2", type_machine)
# machine_H3 = Object("H3", type_machine)
#
# # hard turning
...
def add_base_objects_to_problem(fm_problem):
    ...
    # fm_problem.add_object(machine_H1)
    # fm_problem.add_object(machine_H2)
    # fm_problem.add_object(machine_H3)
    # fm_problem.add_object(machine_T1)
    # fm_problem.add_object(machine_T2)
    # fm_problem.add_object(machine_T3)
    ...
    fm_problem.add_object(step_heat_treatment)
